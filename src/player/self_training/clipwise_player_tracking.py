    ...
    def track_clip(self, clip_images):
        ...
        for img_info in clip_images:
            ...
            anns = [
                ...
                if ann["image_id"] == img_id and ann["category_id"] in [2, 3]
            ]
            ...
            for idx, curr_box in enumerate(current_boxes):
                ...
                for p_idx, prev_box in enumerate(previous_boxes):
                    ...
                    if (
                        iou > self.iou_thresh
                        and center_dist < self.center_thresh
                        and iou > best_score
                    ):
                        best_score = iou
...
def main(
    ...
    for (game_id, clip_id), clip_imgs in tqdm(
        clip_to_images.items(), desc="Tracking clips"
    ):
