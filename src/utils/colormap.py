...
rect_img = Image.alpha_composite(
    rect_img, create_patterned_rect((rect_w, rect_h), (255, 0, 0))
)
...
tri_img = Image.alpha_composite(
    tri_img, create_patterned_rect((tri_side, tri_side), (255, 215, 0))
)
...
w, h = bbox[2] - bbox[0], bbox[3] - bbox[1]
t_draw.text(
    (tri_side / 2 - w / 2, tri_side * 0.55), "さんかく", font=font_small, fill="black"
)
...
circ_img = Image.alpha_composite(
    circ_img, create_patterned_rect((circle_d, circle_d), (0, 0, 255))
)
...
w, h = bbox[2] - bbox[0], bbox[3] - bbox[1]
c_draw.text(
    (circle_d / 2 - w / 2, circle_d / 2 - h / 2), "えん", font=font_small, fill="black"
)
