...
class ResNet50CoordRegression(nn.Module):
    ...
    Args:
        input_channels (int): Number of input channels (e.g., 9 for 3 RGB frames concatenated).
        pretrained (bool): Whether to load ImageNet-pretrained weights.
    """
    def __init__(self, input_channels: int = 9, pretrained: bool = True):
        super().__init__()
        ...
        if input_channels != 3:
            ...
            with torch.no_grad():
                ...
                new_conv.weight.copy_(avg_weight.repeat(1, input_channels, 1, 1))
...
if __name__ == "__main__":
    model = ResNet50CoordRegression(input_channels=9, pretrained=True)
