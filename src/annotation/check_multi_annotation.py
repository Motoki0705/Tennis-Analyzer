...
def main():
    ...
    while 0 <= idx < total:
        ...
        cv2.putText(
            frame, txt, (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 1
        )
        ...
        if key == ord(" "):
            ...
            while (
                idx < total
                and images[idx]["clip_id"] == cur_clip
                and images[idx]["game_id"] == game_id
            ):
                idx += 1
        elif key == ord("g"):  # next game
            cur_game = game_id
            while idx < total and images[idx]["game_id"] == cur_game:
                idx += 1
