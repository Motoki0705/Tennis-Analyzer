...
from src.court.models.vit_unet import ViTUNet
# =============================================================================
# PyTorch Lightning モジュール
# ViTUNetをLitSwinUNetのテンプレートに統合
# =============================================================================

class LitViTUNet(pl.LightningModule):
    """
    ViTUNet用LightningModule with Focal Loss and Finetuning Logic.
    """
    def __init__(
        self,
        # Model parameters
        ...
        # モデルの初期化
        # 【変更点】SwinUNetからViTUNetに変更
        self.model = ViTUNet(
            model_name=model_name,
            in_channels=in_channels,
            out_channels=out_channels,
            img_size=img_size, # ViTUNetはimg_sizeも必要
        )
    ...
    def _common_step(self, batch, stage: str):
        ...
        loss = torchvision.ops.sigmoid_focal_loss(
            inputs=logits,
            targets=target_heatmaps, # 修正: 変換後のターゲットを使用
    ...
    # _find_heatmap_peaks と _calculate_accuracy は LitSwinUNet からコピー
