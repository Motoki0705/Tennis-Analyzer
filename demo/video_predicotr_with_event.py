...
from src.multi.streaming_overlayer.video_predictor_with_event import VideoPredictorWithEvent
...
def setup_video_predictor(cfg: DictConfig, input_path: str, output_path: str) -> VideoPredictorWithEvent:
    ...
    video_predictor = VideoPredictorWithEvent(
        ...
        max_preload_frames=streaming_overlayer_cfg.get("max_preload_frames", 64),
        enable_performance_monitoring=streaming_overlayer_cfg.get("enable_performance_monitoring", True),
        event_sequence_length=streaming_overlayer_cfg.get("event_sequence_length", 128)
    )
